...
class MouvementMachine_model
{
    ...
    public function __construct($num_Mouv_Mach = null, $date_Mouv_Mach = null, $id_machine = null, $id_Rais = null, $idEmp = null, $type_Mouv = null, $statut = null)
    {
        $this->num_Mouv_Mach = $num_Mouv_Mach;
        $this->date_Mouv_Mach = $date_Mouv_Mach;
    ...
    public static function findAll()
    {
        ...
        $req = $conn->query("SELECT mm.*, m.reference, m.designation 
            ...
            ORDER BY mm.date_Mouv_Mach DESC");
        $req->execute();
