...
class CategoriesController {
    public function list() {
        ...
        include(__DIR__ . '/../views/categories/list__categories.php');
    }
    ...
    public function create() {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (Categories_model::StoreCategory($category)) {
                $_SESSION['flash_message'] = ['type' => 'success', 'text' => 'Catégorie ajoutée avec succès !'];
                ...
                $_SESSION['flash_message'] = ['type' => 'error', 'text' => 'Erreur lors de l\'ajout de la catégorie.'];
            }
            header('Location: /public/index.php?route=categories');
            exit;
        }

        include(__DIR__ . '/../views/categories/add_categories.php');
    }
    ...
    public function edit() {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (Categories_model::UpdateCategory($category)) {
                $_SESSION['flash_message'] = ['type' => 'success', 'text' => 'Catégorie modifiée avec succès !'];
             ...
             if (isset($_SESSION['user']['matricule']) && $oldCategory) {
                ...
                $_SESSION['flash_message'] = ['type' => 'error', 'text' => 'Erreur lors de la modification de la catégorie.'];
            }
            header('Location: ../../public/index.php?route=categories');
            exit;
        }
        ...
        include(__DIR__ . '/../views/categories/edit_categories.php');
    }
    ...
    public function delete() {
        ...
        if ($id) {
            ...
            if (Categories_model::deleteById($id)) {
                $_SESSION['flash_message'] = ['type' => 'success', 'text' => 'Catégorie supprimée avec succès !'];
