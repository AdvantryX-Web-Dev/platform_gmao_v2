...
<head>
    <meta charset="UTF-8">
    <title>Editer un maintenancier</title>
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <?php endif; ?>
                            <form method="post" action="../../platform_gmao/public/index.php?route=maintainer/edit&id=<?= urlencode($maintainer['id']) ?>">
                                <div class="form-group">
                                    <label>Card RFID</label>
                                    <input type="text" name="card_rfid" class="form-control" value="<?= htmlspecialchars($maintainer['card_rfid'] ?? '') ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Matricule</label>
                                    <input type="text" name="matricule" class="form-control" value="<?= htmlspecialchars($maintainer['matricule'] ?? '') ?>">
                                </div>
                                <div class="form-group">
                                    <label>Nom</label>
                                    <input type="text" name="first_name" class="form-control" value="<?= htmlspecialchars($maintainer['first_name'] ?? '') ?>" required>
                                </div>
                                <div class="form-group">
                                    <label>Prénom</label>
                                    <input type="text" name="last_name" class="form-control" value="<?= htmlspecialchars($maintainer['last_name'] ?? '') ?>" required>
                                </div>
