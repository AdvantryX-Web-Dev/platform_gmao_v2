...
<head>
    <meta charset="UTF-8">
    <title>Editer une raison de rejet</title>
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            <h6 class="m-0 font-weight-bold text-primary">Editer une raison de rejet</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <?php endif; ?>
                            <form method="post" action="../../platform_gmao/public/index.php?route=rejection_reasons/edit&id=<?= urlencode($rejectionReason['id']) ?>">
                                <div class="form-group">
                                    <label>Raison de rejet</label>
                                    <input type="text" name="reason_name" class="form-control" value="<?= htmlspecialchars($rejectionReason['reason_name'] ?? '') ?>">
                                </div>
                                <div class="form-group">
                                    <label>Description</label>
                                    <input type="text" name="description" class="form-control" value="<?= htmlspecialchars($rejectionReason['description'] ?? '') ?>">
                                </div>



                                <button type="submit" class="btn btn-success">Enregistrer</button>
                                <a href="../../platform_gmao/public/index.php?route=rejection_reasons/list" class="btn btn-secondary ml-2">Annuler</a>
                            </form>
                        </div>
                    </div>
                </div>
